...
googleApiKey = "AIzaSyAfrC2mRrLmbp0xqIPy5YZAw47e7QwCn3U"
...
login = browser.find_elements_by_class_name("includeLink")
login[0].click()
browser.find_element_by_id("uid").send_keys("boriso")
browser.find_element_by_id("password").send_keys("katz111")
table_id = browser.find_element_by_id('')
rows = table_id.find_elements_by_tag("tr")
